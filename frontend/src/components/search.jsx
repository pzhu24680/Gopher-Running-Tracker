...
const Search = ({id,onClick}) => {
    ...
    return (
        <div className='search-bar'>
            <input type="text" className="search-bar" placeholder="search date" onChange={e=>setValue(e.target.value)} value={value} onKeyPress={checkEnter()}></input>
            <button className = "search" onClick={findEntry()}>Search</button> : <button></button>
        </div>
    );
};
